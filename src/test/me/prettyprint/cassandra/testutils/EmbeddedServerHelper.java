...
public class EmbeddedServerHelper {
  ...
  private static void copy(String resource, String directory) throws IOException {
    ...
    System.out.println("EmbeddedCassandraService.class.getResource:" + EmbeddedCassandraService.class.getResource(resource));
    InputStream is = EmbeddedCassandraService.class.getResourceAsStream(resource);
